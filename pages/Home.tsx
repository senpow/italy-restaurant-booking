      ...
      <div className="py-16 bg-stone-100">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <img src="https://images.unsplash.com/photo-1513104890138-7c749659a591?auto=format&fit=crop&w=600&q=80" alt="Pizza" className="rounded-lg shadow-lg h-64 w-full object-cover hover:opacity-90 transition" />
